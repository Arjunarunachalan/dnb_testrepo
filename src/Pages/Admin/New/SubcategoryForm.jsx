          ...
          <div className={Style.right}>
            ...
            <form onSubmit={(e) => handleSubmit(e)}>
              ...
              <div className={Style.formInput}>
                ...
                <select name="categoryname" Selected="Select..." defaultValue="select..." ref={selectRef1} onChange={(e) => { SetCategoryName(e.target.value) }} required >
                ...
                {Visible ?
                  <div className={Style.formWrapper}>
                    ...
                    <div className={Style.formInput}>
                      ...
                      <select name="propertytype" Selected={CurrentInput.label} ref={selectRef2} defaultValue="select..." onChange={(e) => { SetCurrentInput({ ...CurrentInput, type: e.target.value }) }} >
                    ...
                    <div className={Style.formSelect}>
                      ...
                      <select name="categoryname" Selected="Select..." defaultValue="select..." ref={selectRef3} onChange={(e) => { SetCurrentInput({ ...CurrentInput, important: e.target.value }) }}  >
                        <option value="" selected>Choose here</option>
